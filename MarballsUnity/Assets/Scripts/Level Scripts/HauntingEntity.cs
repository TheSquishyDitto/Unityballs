...
public class HauntingEntity : Ghostable {
	...
	protected override void Update () {
		...
		// Used for testing.
		if (Input.GetKeyDown(KeyCode.G) && gm.debug) {
	...
	void OnTriggerEnter() {
		...
		// Otherwise, do something spooky.
			...
			case 5: gm.hud.tipBox.color = Color.black;
					gm.hud.tipMessage.color = Color.white;
					gm.hud.tipMessage.text = "...I see you..."; 
					gm.hud.tipWindow.SetActive(true); break;
			default: break;
			}
		}
	}
